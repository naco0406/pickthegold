...
const Signup = () => {
  ...
  const { email, nickname, userClass } = data;
  const { data: session } = useSession();
  useEffect(() => {
    if (session?.user?.email) {
      setData((prevData) => ({ ...prevData, email: session?.user?.email || "" }));
    }
  }, [session]);
  ...
  return (
    <>
      ...
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-10">
          <div className="absolute left-0 top-0 -z-1 h-2/3 w-full rounded-lg bg-gradient-to-t dark:bg-gradient-to-t dark:to-[#252A42]"></div>
          ...
          >
            ...
            >
              {/* <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-10 lg:flex-row lg:justify-between lg:gap-14">
                <input
                  name="email"
                  type="email"
                  placeholder="이메일 주소"
              ...
              <div className="flex flex-wrap pb-20 gap-10 md:justify-between xl:gap-15">
